...
interface MintDetailPageProps {
  transaction: MintTransactionRow;
  onBack: () => void;
}

export function MintDetailPage({ transaction, onBack }: MintDetailPageProps) {
  ...
  return (
    <div className="mint-detail">
      {/* Back link */}
      <button type="button" className="mint-detail__back" onClick={onBack}>
        <Icon name="arrow_back" size={20} color={undefined} style={undefined} />
        <span>Back to Mint</span>
      </button>

      <div className="mint-detail__content">
        {/* Left: Transaction Details card */}
        <div className="mint-detail__card mint-detail__card--main">
          <div className="mint-detail__card-header">
            <h2 className="mint-detail__card-title">Transaction Details</h2>
            <Tag tone={transaction.status.tone} icon={undefined} onRemove={undefined} onClick={undefined}>
              {transaction.status.label}
            </Tag>
          </div>

          <hr className="mint-detail__divider" />

          {/* Row 1: Transaction ID */}
          <div className="mint-detail__row">
            <div className="mint-detail__field">
              <span className="mint-detail__label">Transaction ID</span>
              <button
                type="button"
                className="mint-detail__value mint-detail__value--copy"
          ...
          <div className="mint-detail__row">
            <div className="mint-detail__field">
              <span className="mint-detail__label">Transaction Hash</span>
              <span className="mint-detail__value mint-detail__value--link">
                {transaction.hash.slice(0, 36) + "...."}
                {transaction.hash.slice(-5)}
              </span>
            </div>
            <div className="mint-detail__field">
              <span className="mint-detail__label">Wallet Address</span>
              <button
                type="button"
                className="mint-detail__value mint-detail__value--copy"
                onClick={() => {
          ...
          <div className="mint-detail__row">
            <div className="mint-detail__field">
              <span className="mint-detail__label">Transaction Type</span>
              <span className="mint-detail__value">{transaction.type}</span>
            </div>
            <div className="mint-detail__field">
          ...
          <div className="mint-detail__row">
            <div className="mint-detail__field">
              <span className="mint-detail__label">
                Transaction Date
                <Icon name="info" size={20} color={undefined} style={undefined} />
              </span>
              <span className="mint-detail__value">{transaction.date}</span>
            </div>
            <div className="mint-detail__field">
              <span className="mint-detail__label">
                Completed Date
              ...
              <span className="mint-detail__value">
          ...
          <div className="mint-detail__row">
            <div className="mint-detail__field">
              <span className="mint-detail__label">Details</span>
              <span className="mint-detail__value">-</span>
            </div>
          </div>
        </div>

        {/* Right: Amount Details card */}
        <div className="mint-detail__card mint-detail__card--amount">
          <h2 className="mint-detail__card-title">Amount Details</h2>

          {/* Cross Asset section */}
          <div className="mint-detail__cross-asset">
            <div className="mint-detail__cross-asset-icons">
              <div className="mint-detail__cross-asset-currency">
                <span
                  className="mint-detail__cross-asset-icon"
                  dangerouslySetInnerHTML={{ __html: CURRENCY_ICONS[transaction.sourceCurrency]?.icon ?? "" }}
                />
                <span className="mint-detail__cross-asset-label">
            ...
            <p className="mint-detail__cross-asset-note">
              Your {transaction.sourceCurrency} is converted 1:1 to {transaction.currency}
            </p>
          </div>

          <div className="mint-detail__amount-rows">
            <div className="mint-detail__amount-row">
              <span className="mint-detail__amount-label">Total Amount</span>
              <span className="mint-detail__amount-value">
                {transaction.totalAmount.toLocaleString()} {transaction.currency}
              </span>
            </div>
            <div className="mint-detail__amount-row">
              <span className="mint-detail__amount-label">Fee</span>
              <span className="mint-detail__amount-value">
            ...
            <div className="mint-detail__amount-row">
              <span className="mint-detail__amount-label">Net Amount</span>
              <span className="mint-detail__amount-value mint-detail__amount-value--bold">
      ...
      {/* Help guide */}
      <div className="mint-detail__guide">
        <Icon name="emoji_objects" size={20} color={undefined} style={undefined} />
        <span>
          Need help?{" "}
          <a href="#" className="mint-detail__guide-link">Learn more</a>
          {" "}about how minting works.
        </span>
      </div>
    </div>
  );
